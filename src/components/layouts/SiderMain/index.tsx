  ...
  return (
    <div className='sider-main px-12px'>
      <div className='flex items-center h-60px'>
        ...
        <span className='brand-text text-24px font-bold italic -mt-1 px-12px tracking-wider'>鲨画</span>
      </div>
      ...
      <div className='client-download relative rounded-md p-12px overflow-hidden'>
        ...
        <p className='client-desc text-14px my-12px leading-normal'>下载Shark鲨画客户端，获取更稳定流畅的编辑体验</p>
        <button className='btn-download h-40px w-100% rounded-md px-15px py-8px text-center font-bold outline-none border-none bg-transparent cursor-pointer transition-all-300'>下载桌面客户端</button>
      </div>
    </div>
  );
}
